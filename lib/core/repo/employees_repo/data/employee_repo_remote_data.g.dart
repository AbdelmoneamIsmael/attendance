...
part of 'employee_repo_remote_data.dart';
...
class _EmployeeRepoRemoteDataImple implements EmployeeRepoRemoteDataImple {
  ...
  @override
  Future<EmployeeInformationResponse> getEmployeeInfoById(int userId) async {
  ...
  Future<EmployeeSearchResult> getSubEmployeesData(
    ...
    _data.addAll(searchParams);
    final _options = _setStreamType<EmployeeSearchResult>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/api/Employees/GetAllSupEmployees',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EmployeeSearchResult _value;
    try {
      _value = EmployeeSearchResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<String> addAttend(Map<String, dynamic> addAttendParams) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addAttendParams);
